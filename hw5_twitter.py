...
def find_most_common_cooccurring_hashtag(tweet_data, hashtag_to_ignore):
    ...
    for tweet in tweets:
        ...
        for hashtag in hashtag_list:
            hashtag_count.append(hashtag['text'])
    cooccour_hashtags = []
    for key in Counter(hashtag_count).keys():
        cooccour_hashtags.append(key)
    second_most_common_hashtag = "#" + cooccour_hashtags[1]
    return second_most_common_hashtag      
